  ...
  validateForm() {
    ...
    if (typeof fields["password"] !== "undefined") {
      if (
        ...
        formIsValid = false;
        errors["password"] =
          "Minimum 8 characters in length( Contains Lowercase Letters, Uppercase Letters and Symbols)";
      }
    }
          ...
          <div id="register">
            ...
            >
              ...
              <input
                type="text"
                name="secretquestion"
                value={this.state.fields.secretquestion}
                onChange={this.handleChange}
              />
              ...
              <input
                type="text"
                name="secretanswer"
                value={this.state.fields.secretanswer}
                onChange={this.handleChange}
              />
